...
function OwnersOverviewByEmployeeReportModal({ isOpen, onClose }) {
  const { showSuccess, showInfo } = useToast();
  
  const [formData, setFormData] = useState({
    startDate: '09/08/2025',
    endDate: '09/08/2025',
    employee: 'John Cusmano'
  });
  ...
  const handleRunReport = () => {
    showSuccess('📈 Running Owners Overview By Employee report...');
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-4xl">
          <div className="p-8">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-blue-800 mb-4">Employee Overview</h1>
...
export default OwnersOverviewByEmployeeReportModal;