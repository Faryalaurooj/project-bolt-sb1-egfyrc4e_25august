...
function ReportsMenu() {
  ...
  const [isBusinessStructureReportModalOpen, setIsBusinessStructureReportModalOpen] = React.useState(false);
  const [isBrokerListReportModalOpen, setIsBrokerListReportModalOpen] = React.useState(false);
  const [isCSRReportModalOpen, setIsCSRReportModalOpen] = React.useState(false);
  const [isDueDatesReportModalOpen, setIsDueDatesReportModalOpen] = React.useState(false);
  const [isFollowUpNotesReportModalOpen, setIsFollowUpNotesReportModalOpen] = React.useState(false);
  const [isHiddenInactiveReportModalOpen, setIsHiddenInactiveReportModalOpen] = React.useState(false);
  const [isNotesSystemAddedReportModalOpen, setIsNotesSystemAddedReportModalOpen] = React.useState(false);
  const [isNotesUserAddedReportModalOpen, setIsNotesUserAddedReportModalOpen] = React.useState(false);
