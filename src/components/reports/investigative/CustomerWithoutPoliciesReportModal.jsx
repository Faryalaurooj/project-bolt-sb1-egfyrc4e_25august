...
function CustomerWithoutPoliciesReportModal({ isOpen, onClose }) {
  ...
  const customerStatusOptions = ['All Customers', 'Active', 'Prospects', 'Inactive'];
  const orderByOptions = ['Customer Name', 'Date Added', 'Last Contact', 'Office'];
  ...
  const handleSaveReport = () => {
    showInfo('📊 Customer W/O Policies report saved for future use!');
  };

  const handleRunReport = (format) => {
    showSuccess(`📈 Running Customer W/O Policies report as ${format}...`);
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Customer W/O Policies</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Customer W/O Policies:</span>
                    <span className="text-gray-700 ml-2">
                      This report lists customers in your database who do not currently have any active policies, helping identify prospects for new business opportunities.
                    </span>
                  </div>
                </div>
              </div>
...
export default CustomerWithoutPoliciesReportModal;