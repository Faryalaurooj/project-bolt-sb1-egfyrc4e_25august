...
function MixedPoliciesReportModal({ isOpen, onClose }) {
  ...
  const handleSaveReport = async () => {
    try {
      ...
      showSuccess('📊 Mixed Policies report saved for future use!');
    } catch (error) {
      showInfo('📊 Mixed Policies report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Mixed Policies report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Mixed Policies report as ${format}...`);
    }
  };
