...
function PoliciesByCompanyReportModal({ isOpen, onClose }) {
  ...
  const orderByOptions = ['Company Name', 'Policy Count', 'Customer Name', 'Effective Date'];
  ...
  const handleSaveReport = () => {
    showInfo('📊 Policies By Company report saved for future use!');
  };

  const handleRunReport = (format) => {
    showSuccess(`📈 Running Policies By Company report as ${format}...`);
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Policies By Company</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Policies By Company:</span>
                    <span className="text-gray-700 ml-2">
                      This report shows the distribution of policies across different insurance companies, helping analyze carrier relationships and market share.
                    </span>
                  </div>
                </div>
              </div>
...
export default PoliciesByCompanyReportModal;