...
function PoliciesWithPaymentsReportModal({ isOpen, onClose }) {
  ...
  const statusOptions = ['Any Status', 'Active', 'Pending', 'Expired', 'Cancelled'];
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Policies With Payments Report',
        reportType: 'policies_with_payments',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Policies With Payments report saved for future use!');
    } catch (error) {
      showInfo('📊 Policies With Payments report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Policies With Payments report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Policies With Payments report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Policies With Payments</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Policies With Payments:</span>
                    <span className="text-gray-700 ml-2">
                      This report lists policies entered into the system within the given date range, along with the 
                      amount paid on that policy.
                    </span>
                  </div>
                </div>
              </div>
...
export default PoliciesWithPaymentsReportModal;