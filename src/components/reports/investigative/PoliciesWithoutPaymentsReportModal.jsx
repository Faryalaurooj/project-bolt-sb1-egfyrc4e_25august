...
function PoliciesWithoutPaymentsReportModal({ isOpen, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    endDate: '09/08/2025',
    asOfDate: '09/08/2025',
    reportType: 'New & Renewal Policies Without Payments',
  ...
  const reportTypeOptions = ['New & Renewal Policies Without Payments', 'All Policies Without Payments', 'Active Policies Without Payments'];
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Policies Without Payments Report',
        reportType: 'policies_without_payments',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Policies Without Payments report saved for future use!');
    } catch (error) {
      showInfo('📊 Policies Without Payments report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Policies Without Payments report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Policies Without Payments report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Policies Without Payments</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <EditableSelect 
                    ...
                    onChange={v => handleInputChange('reportType', v)} 
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Policies Without Payments:</span>
                    <span className="text-gray-700 ml-2">
                      This report will list policies that do not have any payments within the date range 
                      selected.
                    </span>
                  </div>
                </div>
...
export default PoliciesWithoutPaymentsReportModal;