...
function ReceiptListReportModal({ isOpen, onClose }) {
  ...
  const paymentMethodOptions = ['- All Payment Methods -', 'Cash', 'Check', 'Credit Card', 'Bank Transfer'];
  const orderByOptions = ['Office', 'Customer Name', 'Receipt Date', 'Amount'];
  ...
  const handleSaveReport = () => {
    showInfo('📊 Receipt List report saved for future use!');
  };

  const handleRunReport = (format) => {
    showSuccess(`📈 Running Receipt List report as ${format}...`);
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Receipt List</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <EditableSelect 
                    ...
                    onChange={v => handleInputChange('paymentMethod', v)} 
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Receipt List:</span>
                    <span className="text-gray-700 ml-2">
                      This report lists all payment receipts collected within the specified date range, organized by payment method and customer.
                    </span>
                  </div>
                </div>
              </div>
...
export default ReceiptListReportModal;