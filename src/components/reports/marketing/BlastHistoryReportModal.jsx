...
function BlastHistoryReportModal({ isOpen, onClose }) {
  ...
  const blastTypeOptions = ['Text', 'Email', 'Letter', 'All Types'];
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Blast History Report',
        reportType: 'blast_history',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Blast History report saved for future use!');
    } catch (error) {
      showInfo('📊 Blast History report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Blast History report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Blast History report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Blast History</h2>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Blast Type:</label>
                  <EditableSelect 
                    value={formData.blastType} 
                    onChange={v => handleInputChange('blastType', v)} 
                    options={blastTypeOptions} 
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Blast History:</span>
                    <span className="text-gray-700 ml-2">
                      This report will display a summary list of all text, email, and letter blasts sent within a given date 
                      range. The total count of Customers included in a Blast is displayed as a link. Clicking this link will open a new tab and list 
                      those Customers.
                    </span>
                  </div>
                </div>
...
export default BlastHistoryReportModal;