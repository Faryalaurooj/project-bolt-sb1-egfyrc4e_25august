...
function CompanyEmailHistoryReportModal({ isOpen, onClose }) {
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Company Email History Report',
        reportType: 'company_email_history',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Company Email History report saved for future use!');
    } catch (error) {
      showInfo('📊 Company Email History report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Company Email History report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Company Email History report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Company Email History</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Company Email History:</span>
                  </div>
                </div>
              </div>
            </div>
...
export default CompanyEmailHistoryReportModal;