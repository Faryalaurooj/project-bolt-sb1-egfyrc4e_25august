...
function NotesSystemAddedReportModal({ isOpen, onClose }) {
  ...
  const noteTypeOptions = ['All System Notes', 'Policy Updates', 'Payment Notifications', 'System Alerts'];
  const orderByOptions = ['Date Added', 'Customer Name', 'Note Type', 'Office'];
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Notes - System Added Report',
        reportType: 'notes_system_added',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Notes - System Added report saved for future use!');
    } catch (error) {
      showInfo('📊 Notes - System Added report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Notes - System Added report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Notes - System Added report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Notes - System Added</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Notes - System Added:</span>
                    <span className="text-gray-700 ml-2">
                      This report displays all notes that were automatically added by the system within the specified date range.
                    </span>
                  </div>
                </div>
              </div>
...
export default NotesSystemAddedReportModal;