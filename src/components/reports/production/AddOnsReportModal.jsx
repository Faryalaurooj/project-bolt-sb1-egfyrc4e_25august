...
function AddOnsReportModal({ isOpen, onClose }) {
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Add Ons Report',
        reportType: 'add_ons',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Add Ons report saved for future use!');
    } catch (error) {
      showInfo('📊 Add Ons report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Add Ons report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Add Ons report as ${format}...`);
    }
  };
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Add Ons:</span>
                    <span className="text-gray-700 ml-2">
                      This report shows premium and Cost of Add Ons for the given date range.
                    </span>
                  </div>
                </div>
              </div>
...
export default AddOnsReportModal;