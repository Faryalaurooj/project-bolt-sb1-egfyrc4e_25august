...
function BookOfBusinessSummaryReportModal({ isOpen, onClose }) {
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'Book Of Business Summary Report',
        reportType: 'book_of_business_summary',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 Book Of Business Summary report saved for future use!');
    } catch (error) {
      showInfo('📊 Book Of Business Summary report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Book Of Business Summary report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Book Of Business Summary report as ${format}...`);
    }
  };
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-blue-600 text-white p-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Book Of Business Summary</h2>
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Book of Business Summary Report:</span>
                    <span className="text-gray-700 ml-2">
                      This report provides a summarized view of all policies whose effective date is within the date range selected. The As of Date checked against the date the policy records are created in the system.
                    </span>
                  </div>
                </div>
              </div>
...
export default BookOfBusinessSummaryReportModal;