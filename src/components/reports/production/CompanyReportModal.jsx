...
function CompanyReportModal({ isOpen, onClose }) {
  ...
  const handleSaveReport = async () => {
    try {
      ...
      showSuccess('📊 Company report saved for future use!');
    } catch (error) {
      showInfo('📊 Company report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 Company report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running Company report as ${format}...`);
    }
  };
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">Company Production:</span>
                    <span className="text-gray-700 ml-2">
                      This report lists the number of new and renewed policies (based on types INCLUDED from list above) entered into the system within the date range given.
                    </span>
                  </div>
                </div>
              </div>
