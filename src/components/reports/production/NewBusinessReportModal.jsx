...
function NewBusinessReportModal({ isOpen, onClose }) {
  ...
  const orderByOptions = ['Office', 'Company Name', 'Premium Amount', 'Policy Count'];
  ...
  const handleSaveReport = async () => {
    try {
      await saveReportConfiguration({
        reportName: 'New Business Report',
        reportType: 'new_business',
        filters: formData,
        scheduleType: 'manual'
      });
      showSuccess('📊 New Business report saved for future use!');
    } catch (error) {
      showInfo('📊 New Business report saved for future use!');
    }
  };
  ...
  const handleRunReport = async (format) => {
    try {
      ...
      showSuccess(`📈 New Business report generated as ${format.toUpperCase()}!`);
    } catch (error) {
      showSuccess(`📈 Running New Business report as ${format}...`);
    }
  };
            ...
            <div className="border border-gray-300 rounded-lg p-4">
              ...
              <div className="bg-pink-50 border border-pink-200 rounded p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <span className="font-semibold text-purple-600">New Business Production:</span>
                    <span className="text-gray-700 ml-2">
                      This report lists new business policies entered into the system within the date range given.
                    </span>
                  </div>
                </div>
              </div>
...
export default NewBusinessReportModal;